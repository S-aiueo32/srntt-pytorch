"""
This code was coppied from the original implementation and adjusted our file structure.
"""
...
parser.add_argument('--dataset_name', type=str, default='CUFED5',
                    help='The name of dataset: CUFED5, DIV2K, or CUFED')
...
datasets = {
    'CUFED5': {
        'name': 'CUFED5',
        'url': CUFED5_TEST_DATA_URL,
        'save_dir': 'data/',
        'data_size': 233
    },
    'DIV2K_input': {
        'name': 'DIV2K_input',
        'url': DIV2K_INPUT_PATCH_DATA_URL,
        'save_dir': 'data/DIV2K/',
        'data_size': 1835
    },
    'DIV2K_ref': {
    ...
    'CUFED_input': {
        'name': 'CUFED_input',
        'url': CUFED_INPUT_PATCH_DATA_URL,
        'save_dir': 'data/CUFED/',
        'data_size': 567
    },
    'CUFED_ref': {
        'name': 'CUFED_ref',
        'url': CUFED_REF_PATCH_DATA_URL,
        'save_dir': 'data/CUFED/',
        'data_size': 588
    }
}
